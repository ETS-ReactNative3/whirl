    ...
    Auth.signUp({
      ...
      .then(data => {
        ...
        setTimeout(() => {
          Alert.alert(
            'Your signed up!',
            'Please verify your email address by following the link in the email sent to you. You must do this before using the app.'
          );
        }, 0);
      })
      .catch(err => {
  ...
  return dispatch => {
    ...
    setTimeout(() => {
      Alert.alert(
        ...
        'Once you have verified your email address you will be able to log in!'
      );
    }, 0);
  };
}
